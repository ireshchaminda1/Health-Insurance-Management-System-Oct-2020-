...
<h1 style="margin-left:50px;">Update feedback</h1>
<div class="container">
<form action="FBedit.php" method="POST">
	<label for="fname"style="margin-left:50px;"><b>First Name:</b></label><br>
	<input type="text" id="fname" name="fname"style="margin-left:50px;border-radius:8px;"  size = "40"required><br>
	<label for="lname"style="margin-left:50px;"><b>Last Name:</b></label><br>
	<input type="text" id="lname" name="lname"style="margin-left:50px;border-radius:8px;" size = "40"required><br>
	<label for="email"style="margin-left:50px;"><b>Enter your e-mail:</b></label><br>
	<input type="email" id="email" name="email"style="margin-left:50px;border-radius:8px;" size = "40" placeholder = "abc@gmail.com"required><br>
	<label for="tnumber"style="margin-left:50px;"><b>Mobile number:</b></label><br>
	<input type="tel" id="tnumber"style="margin-left:50px;border-radius:8px;" name="tnumber" placeholder="123-456-7890" pattern="[0-9]{10}" size = "40"required><br>
	<label for="feedback"style="margin-left:50px;"><b>Type Here Your Feedback:</b></label><br>
	<textarea id="feedback" name="feedback" rows="4" cols="50"style="margin-left:50px;border-radius:8px;"></textarea><br><br>
	<input onclick="myFunction()" class="w3-button w3-border w3-hover-black" type="submit" id="btn1" name="btn1" value="Send Your Feedback" style="margin-left:50px;border-radius:8px;width:200px;"><br>
	<br>
	<br>
</form>
</div>
